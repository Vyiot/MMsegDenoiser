...
train_pipeline = [
    ...
    dict(
        type='Collect',
        keys=['img', 'gt_semantic_seg', 'timesteps'],
        meta_keys=[
...
diffusion_eval = dict(
    interval=1300,
    label_dir='/home/ubuntu/vy/Denoiser/OEM_v2_Building/labels',
    pseudo_dir='/home/ubuntu/vy/Denoiser/OEM_v2_Building/pseudolabels')
device = 'cuda'
work_dir = './work_dirs/deeplabv3plus_r101_512x512_40k_denoise_diffusion'
gpu_ids = range(0, 1)
