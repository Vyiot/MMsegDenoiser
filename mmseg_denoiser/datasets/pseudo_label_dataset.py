...
class PseudoLabelDenoiseDataset(CustomDataset):
    ...
    def prepare_train_img(self, idx: int) -> Dict:
        ...
        Returns:
            dict: Training data dict with keys:
                - img: satellite image
                - gt_semantic_seg: clean label
                - pseudo_label: noisy pseudo-label
                - img_info, ann_info, seg_fields, etc.
        """
        img_info = self.img_infos[idx]
        ann_info = self.get_ann_info(idx)

        # Add pseudo-label path to results
